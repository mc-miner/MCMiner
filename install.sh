...
CLI_LAUNCHER_MARKER="Generated by MCMiner install.sh"
...
load_language() {
    ...
    1)
        ...
        prompt_control_api_question="Enable the control API? MCMiner will restart after this change."
        ...
        msg_cli_main_missing="MCMiner is not installed. Please choose 1 to install MCMiner first, then install the CLI tool."
        ...
        msg_cli_install_done_run="Run rustminer to open the CLI tool. Use rustminer start, rustminer stop, or rustminer restart to control MCMiner."
        ...
        msg_cli_install_warning_title="Before installing the CLI tool, MCMiner WEB access must be disabled."
        ...
        msg_web_ui_change_notice_title="Changing WEB access will restart MCMiner."
        ...
        msg_web_ui_change_continue="1. Continue and restart MCMiner"
    ...
    2)
        ...
        prompt_control_api_question="是否开启控制API？修改后 MCMiner 将自动重启。"
        ...
        msg_cli_main_missing="MCMiner 尚未安装，请先选择 1 安装 MCMiner，再安装命令行工具。"
        ...
        msg_cli_install_done_run="运行 rustminer 命令即可打开命令行工具；运行 rustminer start、rustminer stop、rustminer restart 可启动、停止、重启 MCMiner。"
        msg_cli_install_done_path="命令行工具路径"
        msg_cli_install_done_link="命令启动脚本"
        msg_cli_install_done_doc="命令行工具说明/使用文档"
        msg_cli_install_warning_title="安装命令行工具前，需要关闭 MCMiner 的 WEB 访问。"
...
create_cli_launcher() {
    ...
    if [ "$lang_choice" = "2" ]; then
        ...
        text_app_missing="未找到 MCMiner 主程序，请先完成安装。"
        text_cli_missing="未找到 MCMiner CLI，请重新安装命令行工具。"
        text_cli_requires_web_disabled="命令行工具仅在 WEB 访问关闭时可用。请先运行安装脚本并选择关闭 WEB 访问。"
        text_already_running="MCMiner 已在运行。"
        text_started="MCMiner 已启动。"
        text_start_failed="MCMiner 启动失败。"
        text_not_running="MCMiner 未运行。"
        text_stopped="MCMiner 已停止。"
        text_stop_timeout="MCMiner 停止超时。"
    else
        ...
        text_app_missing="MCMiner is not installed. Please install it first."
        text_cli_missing="MCMiner CLI was not found. Please reinstall the CLI tool."
        ...
        text_already_running="MCMiner is already running."
        text_started="MCMiner started."
        text_start_failed="MCMiner start failed."
        text_not_running="MCMiner is not running."
        text_stopped="MCMiner stopped."
        text_stop_timeout="MCMiner stop timeout."
    fi
...
show_runtime_status() {
    ...
    if [ "$lang_choice" = "2" ]; then
        ...
        label_title="MCMiner Runtime Status"
        label_basic="Basic"
